...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('April 13, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Senin, 14 April 2025.", " ", "Hari ini bukan sekadar pertambahan usia,", "melainkan sebuah perayaan akan perjalanan luar biasa yang telah kamu lalui,", "dan harapan besar untuk hari-hari yang menantimu." , " ", "Di usia seperempat abad ini,", "semoga setiap langkahmu dipenuhi keyakinan,", "setiap harapanmu dirangkul dengan kekuatan,", "dan setiap doamu dijawab dengan kebaikan."],
  startDelay: 4000,
  speed: 75,
